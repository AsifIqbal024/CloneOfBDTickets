...
if (from && to && selectedDate && selectedDate) {
  ...
  if (availableBus.length === 0) {
    ...
    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/38/Iceland_road_sign_B03.32.svg/2048px-Iceland_road_sign_B03.32.svg.png" width="300px" />
    <h1 style="text-align: center;">Sorry, No Buses Are Available.</h1>
    </div>`;
  } else {
